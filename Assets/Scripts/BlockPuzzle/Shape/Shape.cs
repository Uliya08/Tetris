...
public class Shape : MonoBehaviour, IPointerClickHandler, IPointerUpHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerDownHandler
{
    ...
    private Vector2 _pointerOffset; // Смещение между центром фигуры и точкой клика

    public void OnBeginDrag(PointerEventData eventData)
    {
        // Запоминаем текущий scale
        this.GetComponent<RectTransform>().localScale = shapeSelectedScale;

        // Рассчитываем смещение курсора относительно центра фигуры
        ...
        _pointerOffset = (Vector2)_transform.localPosition - localPointerPos;
    }

    public void OnDrag(PointerEventData eventData)
    {
        // Получаем новую позицию курсора в пространстве канваса
        RectTransformUtility.ScreenPointToLocalPointInRectangle(
            _canvas.transform as RectTransform,
            eventData.position,
            eventData.pressEventCamera,
        ...
        // Применяем сохранённое смещение
        _transform.localPosition = localPointerPos + _pointerOffset;
    }
